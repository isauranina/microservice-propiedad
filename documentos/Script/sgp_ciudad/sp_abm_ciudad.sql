drop function if exists sp_abm_ciudad;
CREATE OR REPLACE FUNCTION sp_abm_ciudad(
    accion int
	,_num_sec bigint
	,_nsec_pais bigint default null
    ...
    case accion	
        ...
        --MODIFICAR
      	...
      	begin
            ...
            --ACTUALIZA DATOS
            UPDATE sgp_ciudad SET 
				nsec_pais = _nsec_pais:: bigint
        ...
        when 3 then
        begin			
            perform num_sec from sgp_ciudad where estado = 'BA' and num_sec = _num_sec::bigint limit 1;
            if found then
